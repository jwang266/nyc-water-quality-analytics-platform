...
const boroughDes = JSON.parse(fs.readFileSync(path.join(process.cwd(), 'seedData', 'boroughsDescription.json'), 'utf-8'));
/**
...
export const createOrUpdateBoroughs = async () => {
    ...
    for (const [bName, data] of Object.entries(boroughMap)) {
        ...
        const avgB = (key) => borough_sample_count
