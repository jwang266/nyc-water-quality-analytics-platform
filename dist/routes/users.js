...
router.post('/edit-profile', requireAuth, async (req, res) => {
    ...
    try {
        const updatedUser = await userData.updateUser(req.session.user.id, fname, lname, email);
...
router.post('/forgot-password', async (req, res) => {
    ...
    try {
        ...
        let message = 'If an account with that email exists, you will receive password reset instructions.';
        let resetLink = null;
        if (result) {
